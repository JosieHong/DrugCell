###
 ...
 # @LastEditors: yuhhong
 # @LastEditTime: 2022-05-03 14:47:29
### 
#!/bin/bash
inputdir="../data/"
...
python -u ../code/train_our_drugcell_graph.py -onto $ontfile -gene2id $gene2idfile -drug2id $drug2idfile -cell2id $cell2idfile -train $traindatafile -test $valdatafile -model $modeldir -cuda $cudaid -genotype $mutationfile -fingerprint $drugfile -genotype_hiddens 6 -drug_hiddens '4,5,6' -final_hiddens 6 -epoch 100 -batchsize 640 -lr 0.0001
