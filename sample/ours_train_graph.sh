###
 ...
 # @LastEditors: yuhhong
 # @LastEditTime: 2022-05-06 19:21:30
### 
#!/bin/bash
inputdir="../data/"
...
python -u ../code/train_our_drugcell_graph.py -onto $ontfile -gene2id $gene2idfile -drug2id $drug2idfile -cell2id $cell2idfile -train $traindatafile -test $valdatafile -model $modeldir -cuda $cudaid -genotype $mutationfile -fingerprint $drugfile -genotype_hiddens 6 -drug_hiddens '21,16,16,8,8,6,6' -final_hiddens 6 -batchsize 16 -epoch 100 -lr 0.001
